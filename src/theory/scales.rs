...
impl Scale {
    pub const ALL: &[Scale] = &[
        ...
        Scale {
            name: "Harmonic Minor",
            parent: ParentScale::HarmonicMinor,
            degree: 1,
        ...
        Scale {
            name: "Superlocrian \u{266D}\u{266D}7",
            parent: ParentScale::HarmonicMinor,
            degree: 7,
        ...
        Scale {
            name: "Melodic Minor",
            parent: ParentScale::MelodicMinor,
            degree: 1,
        ...
        Scale {
            name: "Harmonic Major",
            parent: ParentScale::HarmonicMajor,
            degree: 1,
            semitones: [0, 2, 4, 5, 7, 8, 11],
        },
        Scale {
            name: "Dorian \u{266D}5",
            parent: ParentScale::HarmonicMajor,
            degree: 2,
            semitones: [0, 2, 3, 5, 6, 9, 10],
        },
        Scale {
            name: "Phrygian \u{266D}4",
            parent: ParentScale::HarmonicMajor,
            degree: 3,
            semitones: [0, 1, 3, 4, 7, 8, 10],
        },
        Scale {
            name: "Melodic Minor #4",
            parent: ParentScale::HarmonicMajor,
            degree: 4,
            semitones: [0, 2, 3, 6, 7, 9, 11],
        },
        Scale {
            name: "Mixolydian \u{266D}2",
            parent: ParentScale::HarmonicMajor,
            degree: 5,
