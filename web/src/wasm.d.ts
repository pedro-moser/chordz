declare module '$wasm/chordz.js' {
  ...
  export function generate_gmc_line(chart_text: string, title: string, pair_index: number, scale_overrides_js: any, figure_index: number, positions_js: number[], pattern_js: any): any;
